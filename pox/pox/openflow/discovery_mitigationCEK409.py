...
private_key = ec.generate_private_key(ec.SECT409K1(), default_backend())

public_key = private_key.public_key()

f1=open("GenerazionePacchettoLLDPMitigazioneCEK409.txt", 'w')
f2=open("ProcessamentoPacchettoLLDPMitigazioneCEK409.txt", 'w')
