...
private_key = ec.generate_private_key(ec.SECT283K1(), default_backend())

public_key = private_key.public_key()

f1=open("GenerazionePacchettoLLDPMitigazioneCEK283.txt", 'w')
f2=open("ProcessamentoPacchettoLLDPMitigazioneCEK283.txt", 'w')
